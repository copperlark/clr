...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("CopperLark version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  copperlarkd [options]                     " + "\n" +
                  "  copperlarkd [options] <command> [params]  " + _("Send command to -server or copperlarkd") + "\n" +
                  "  copperlarkd [options] help                " + _("List commands") + "\n" +
                  "  copperlarkd [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: copperlark.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: copperlarkd.pid)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (fDaemon)
        fprintf(stdout, "CopperLark server starting\n");
